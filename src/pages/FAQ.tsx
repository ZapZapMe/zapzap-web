...
const faqData = [
    {
      ...
      answer: "Tip people who say awesome things. Get tips for your tweets directly into your wallet.",
    },
    {
      question: "Why did you do this?",
      answer: "We want to encourage bolt12 use. And tipping is a fantastic way to demo it.",
    },
    {
      question: "Which wallets does it work with?",
      answer: "Any wallet that supports Bolt12 (Phoenix, Strike, Wallet of Satoshi).",
    },
    {
      question: "Have I received any tips?",
      answer: "You can check by going to zap-zap.me/your-twitter-username and checking.",
    },
    {
    ...
    {
      question: "Can I tip…",
      answer: "You can tip anyone and we will forward them their tip the moment they add a bolt12 address.",
    },
    {
    ...
    },
    {
      ...
      answer: "We can't: all we know is your X username and your bolt12 address. But we could send you sweet sats.",
    },
    {
    ...
    },
    {
      ...
      answer: "We charge nothing. Our SDK provider does charge some minimal lightning routing fees though.",
    },
]
        ...
        <dl className="faq-container space-y-4">
          {faqData.map((item, index) => (
            ...
            >
              ...
              {/* ======== answer ========= */}
              <dd className={`faq-answer ${openIndices.includes(index) ? "expanded" : ""}`}>
                {item.answer}
              </dd>
            </div>
          ))}
