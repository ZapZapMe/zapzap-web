...
const ProfileTop = ({ username = "zapzap_me", walletAddress = "self_profile@strike.me" }) => (
  <div className="profileTop">
    <div className="profilePicRow">
      <img className="profilePicImg" src="img/dp.png" alt="Profile" />
      <a href={`http://x.com/${username}`} target="_blank" rel="noopener noreferrer">
    ...
    <div className="profileWalletRow">
      ...
      <a href="settings.html" className="profileEditWalletIcon">
        <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
          <path fillRule="evenodd" clipRule="evenodd" d="M0 12.6222V16H3.37778L12.6667 6.66667L9.33333 3.33333L0 12.6222ZM15.7333 3.55556C16.0889 3.2 16.0889 2.66667 15.7333 2.31111L13.6889 0.266667C13.3333 -0.0888889 12.8 -0.0888889 12.4444 0.266667L10.8444 1.86667L14.2222 5.24444L15.7333 3.55556Z" />
        </svg>
      </a>
    </div>
  </div>
